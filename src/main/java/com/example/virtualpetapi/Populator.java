...
public void run(String... args) throws Exception {
    ...
    // OrganicDog dog2 = new OrganicDog("Frisbee", "Golden retriever who likes
    // frisbees");
    // organicDogRepository.save(dog2);
    // logger.info("Saved organic dog: {}", dog2);
    ...
    // RoboticDog roboDog1 = new RoboticDog("Lemon", "Enjoys the scent of citrus
    // wax");
    // roboticDogRepository.save(roboDog1);
    // logger.info("Saved robotic dog: {}", roboDog1);
    ...
    // // Associate pets with shelters
    // shelter4.getOrgCats().addAll(Arrays.asList(cat1, cat2));
    // shelter4.getOrgDogs().addAll(Arrays.asList(dog3));
    // shelter4.getRoboDogs().addAll(Arrays.asList(roboDog1));

    // shelter3.getOrgCats().addAll(Arrays.asList(cat5));
    // shelter3.getRoboCats().addAll(Arrays.asList(roboCat2));
    // shelter3.getOrgDogs().addAll(Arrays.asList(dog1));

    // shelter1.getRoboDogs().addAll(Arrays.asList(roboDog2));
    // shelter1.getRoboCats().addAll(Arrays.asList(roboCat1));
    // shelter1.getOrgDogs().addAll(Arrays.asList(dog2));

    // shelter2.getRoboDogs().addAll(Arrays.asList(roboDog1));
    // shelter2.getOrgCats().addAll(Arrays.asList(cat3, cat4));

    // shelterRepository.saveAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));

    // volunteer1.getShelters().addAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));
    // volunteer2.getShelters().addAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));
    // volunteer3.getShelters().addAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));
    // volunteer4.getShelters().addAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));
    // volunteer5.getShelters().addAll(Arrays.asList(shelter1, shelter2, shelter3,
    // shelter4));
    // volunteer6.getShelters().addAll(Arrays.asList(shelter1, shelter2));
    // volunteer7.getShelters().addAll(Arrays.asList(shelter1, shelter2));
    // volunteer8.getShelters().addAll(Arrays.asList(shelter1, shelter2));
    ...
    // volunteerRepository.saveAll(Arrays.asList(volunteer1, volunteer2, volunteer3,
...
// OrganicDog dog4 = new OrganicDog("Caramel", "Caramel colored floof");
// organicDogRepository.save(dog4);
// logger.info("Saved organic dog: {}", dog4);

// OrganicDog dog5 = new OrganicDog("Coby", "Pretty pitbull");
// organicDogRepository.save(dog5);
// logger.info("Saved organic dog: {}", dog5);
...
// Shelter shelter1 = new Shelter("Pet Time");
// shelterRepository.save(shelter1);
// logger.info("Saved shelter: {}", shelter1);

// Shelter shelter2 = new Shelter("Pets R Us");
// shelterRepository.save(shelter2);
// logger.info("Saved shelter: {}", shelter2);

// Shelter shelter3 = new Shelter("Pawsome Pets");
// shelterRepository.save(shelter3);
// logger.info("Saved shelter: {}", shelter3);

// Shelter shelter4 = new Shelter("Blips and Chitz");
// shelterRepository.save(shelter4);
// logger.info("Saved shelter: {}", shelter4);
